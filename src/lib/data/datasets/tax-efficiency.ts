 ...
 */
export const TAX_GROUP_DEFAULTS: Readonly<Record<string, Omit<CountryTaxData, "country">>> = {
  HIC: {
    incomeTaxRate: 30,
    corporateTaxRate: 23,
    salesTaxRate: 18,
